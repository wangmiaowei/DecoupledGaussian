...
class SegAnyGSUtils:
    ...
    def get_segment_mask_by_raw_feature_list(
        ...
        #print('scale_conditioned_sematics_features.shape: ',scale_conditioned_semantic_features.shape)
        ...
        #print("similarity_shape: ",similarities.shape)
