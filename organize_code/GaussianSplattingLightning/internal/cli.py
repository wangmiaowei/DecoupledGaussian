...
class CLI(LightningCLI):
    def add_arguments_to_parser(self, parser: LightningArgumentParser) -> None:
        ...
        parser.add_argument("--name", "-n", type=Optional[str], default=None,
                            help="the training result output path will be '../exp_res/name'")
        parser.add_argument("--version", "-v", type=Optional[str], default=None,
                            help="the training result output path will be '../exp_res/name/version'")
        ...
        parser.add_argument("--output", type=str, default='', help="the base directory of the output")
