...
import os
#python train.py -s /mnt/wmw/dataset/room -m /mnt/wmw/exp_res/PGSR/room --max_abs_split_points 0 --opacity_cull_threshold 0.05
...
from raw_scene.gaussian_model import GaussianModel
from raw_scene.app_model import AppModel
from gaussian_renderer import render, network_gui
import sys, time
from raw_scene import Scene
...
from raw_scene.cameras import Camera
try:
            ...
            if nearest_cam is not None:
                ...
                if d_mask.sum() > 0:
                    ...
                    if use_virtul_cam is False:
                        ...
                        ref_local_d = render_pkg['plane_depth'].squeeze()
